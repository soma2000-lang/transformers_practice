...
def _get_multi_prompt(
    ...
    *,
    ...
    format_instructions: Optional[str] = FORMAT_INSTRUCTIONS,
    ...
    template = "\n\n".join([prefix, "{tools}", format_instruction, suffix_to_use])
...
def create_pandas_dataframe_agent(
    ...
    return_agent_only: bool = False,
    **kwargs: Any,
) -> Union[AgentExecutor, RunnableAgent]:
